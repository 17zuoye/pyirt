...
test_model.loadFromHandle(open('data/sim_data_simple.txt','r'))
...
#utl.loader.parse_item_paramer(test_param, output_file = 'data/sim_true.txt')
utl.loader.parse_item_paramer(test_model.get_item_param(), output_file = 'data/sim_est.txt')
