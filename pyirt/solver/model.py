    ...
    def _max_step(self):
        ...
        if num_item<num_chunk and self.is_parallel:
            ...
            for item_idx in range(num_item):
                pool_repo[item_idx] = self.item_param_dict[item_idx]
            ...
            for item_idx in range(num_item):
                self.item_param_dict[item_idx] = pool_repo[item_idx]
